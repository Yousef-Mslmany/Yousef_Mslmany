...
void Copy_Array_With_Add_Array_Element(int Array_Source[100], int Array_Destination[100], int Array_Length, int& Array_Destination_Length)
{
    for (int i = 0; i < Array_Length; i++)
    {
...
int main()
{
    ...
    int Array2[100];
    Copy_Array_With_Add_Array_Element(Array, Array2, Array_Length, Array2_Length);
