//This is a soultion to the Problem #35.
#include <iostream>
#include <string>
using namespace std;
int Read_Number()
...
bool Is_Number_In_Array(int Number, int Array[100], int Array_Length)
{

    return Find_Number_Position_In_Array( Number, Array, Array_Length) != -1;
...
int main()
{
    ...
    if (Is_Number_In_Array(Number, Array, Array_Length))
