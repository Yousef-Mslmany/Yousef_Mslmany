//This is a soultion to the Problem #39.
#include <iostream>
#include <string>
using namespace std;
int Read_Number()
...
void Copy_Prime_Number(int Array_Source[100], int Array_Destination[100], int Array_Length, int& Array_Destination_Length)
{
    for (int i = 0; i < Array_Length; i++)
        if (isPrime(Array_Source[i]))
        {
...
int main()
{
    ...
    int Array2[100];
    Copy_Prime_Number(Array, Array2, Array_Length, Array2_Length);
