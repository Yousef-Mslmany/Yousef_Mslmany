//This is a soultion to the Problem #25.
#include <iostream>
#include <string>
using namespace std;
...
int Sum_Array(int Arr[100], int& Arr_Length)
{
    int Sum = 0;
    for (int i = 0; i < Arr_Length; i++)
    {
...
float Array_Average(int Arr[100], int Arr_Length)
{
    return (float)Sum_Array(Arr, Arr_Length) / Arr_Length;
};
int main()
{
    ...
    cout << "Average of all number is : " << Array_Average(Arr, Arr_Length) << endl;
}
